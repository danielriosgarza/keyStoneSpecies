...
model_folder = os.path.join(Path(os.getcwd()).parents[0], 'AgoraModels', 'Anaerostipes')


for env_num in range(14,26):    
    ...
    filePath = os.path.join(Path(os.getcwd()).parents[0], 'files', 'anaerostipes', str(env_num)+'.tsv')
