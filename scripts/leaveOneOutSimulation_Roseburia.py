...
model_folder = os.path.join(Path(os.getcwd()).parents[0], 'AgoraModels', 'Roseburia')
...
for env_num in range(1,26):    
    ...
    filePath = os.path.join(Path(os.getcwd()).parents[0], 'files', 'Roseburia', str(env_num)+'.tsv')
