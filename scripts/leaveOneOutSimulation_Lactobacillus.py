...
model_folder = os.path.join(Path(os.getcwd()).parents[0], 'AgoraModels', 'Lactobacillus')
...
for env_num in range(1,16):    
    ...
    filePath = os.path.join(Path(os.getcwd()).parents[0], 'files', 'Lactobacillus', str(env_num)+'.tsv')
