...
model_folder = os.path.join(Path(os.getcwd()).parents[0], 'AgoraModels', 'Clostridum')
...
for env_num in range(1,26):    
    ...
    filePath = os.path.join(Path(os.getcwd()).parents[0], 'files', 'Clostridum', str(env_num)+'.tsv')
