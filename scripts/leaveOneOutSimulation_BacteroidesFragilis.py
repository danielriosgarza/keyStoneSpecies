...
model_folder = os.path.join(Path(os.getcwd()).parents[0], 'AgoraModels', 'BacteroidesFragilis')
...
for env_num in range(1,26):    
    ...
    filePath = os.path.join(Path(os.getcwd()).parents[0], 'files', 'BacteroidesFragilis', str(env_num)+'.tsv')
